...
<div class="contact-form__content">
    ...
    <form class="form" action="/contacts/confirm" method="POST" novalidate>
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--radio">
                    ...
                    @endphp
                    <label><input type="radio" name="gender" value="1" {{ $selectedGender == 1 ? 'checked' : '' }}>男性</label>
                    <label><input type="radio" name="gender" value="2" {{ $selectedGender == 2 ? 'checked' : '' }}>女性</label>
                    <label><input type="radio" name="gender" value="3" {{ $selectedGender == 3 ? 'checked' : '' }}>その他</label>
                </div>
                <div class="form__error">
                    @error('gender')
                    {{ $message }}
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text">
                    <input type="text" name="email" placeholder="例 test@example.com" value="{{ old('email', session('draft_contact.email')) }}" />
                </div>
                <div class="form__error">
                    @error('email')
                    {{ $message }}
            ...
            <div class="form__group-content">
                <div class="form__input--text">
                    <div class="form__input--text--tel">
                        <input type="text" name="tel1" size="4" placeholder="例: 090" value="{{ old('tel1', session('draft_contact.tel1')) }}"> -
                        <input type="text" name="tel2" size="4" placeholder="例: 1234" value="{{ old('tel2', session('draft_contact.tel2')) }}"> -
                        <input type="text" name="tel3" size="4" placeholder="例: 5678" value="{{ old('tel3', session('draft_contact.tel3')) }}">
                    </div>
                    <input type="hidden" name="tel"
                        value="{{old('tel1', session('draft_contact.tel1')) .old('tel2', session('draft_contact.tel2')) .old('tel3', session('draft_contact.tel3'))}}">
                </div>
                <div class="form__error">
                    @error('tel')
                    {{ $message }}
